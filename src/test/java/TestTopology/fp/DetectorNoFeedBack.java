 ...
 */
public class DetectorNoFeedBack  extends BaseRichBolt implements Constant {

    private static final Logger LOG = LoggerFactory.getLogger(DetectorNoFeedBack.class);
    ...
    public void prepare(Map stormConf, TopologyContext context, OutputCollector collector) {
        ...
        LOG.info("In New Detector, threshold: " + threshold);
    }
